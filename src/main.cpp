...
const string strMessageMagic = "SquareBit Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SquareBit", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Tue, 16 Dec 2014 17:01:19 GMT";
        CTransaction txNew;
        txNew.nTime = 1418749279;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1418749281;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 4793157;
		if(fTestNet)
        {
            block.nNonce   = 4793157;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xde8a67e02e3b83ee2565c807a5d8cdc4bfded2c2995a84ceb4087a9c38d2779d"));
        block.print();
